            ...
            if (compare) {
                if (exist_user.validation && exist_user.active) {
                    ...
                    if (exist_user.validation == false) {
                        ...
                        sendCodeVerification(exist_user.email, verif_code1, exist_user.nom, "Verify your email")
                    }
            ...
            if (compare) {
                if (exist_club.validation && exist_club.active) {
                    ...
                    if (exist_club.validation == false) {
                        ...
                        sendCodeVerification(exist_club.email, verif_code1, exist_club.nom, "Verify your email")
                    }
                    else { reponse.send({ msg: "acc_disactive", type: 'error' }) }
                }
            }
...
exports.recherche = async (requete, reponse) => {
    ...
    if (user) {
        if (user.validation == 1) { reponse.send({ email: user.email }) }
